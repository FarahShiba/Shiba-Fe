    ...
    <div>
      <Container className="home-data">
        <div className="title-container">
          ...
          <div className="home-subtitle">Web Designer</div>
        </div>

        <p className={`home-description ${style.darkText}`}>
          I'm a designer who loves to create beautiful and interactive
          experiences. I'm passionate about creating beautiful and interactive
          experiences.
        </p>
        <Button
          href="#contact"
          variant="dark"
          size="lg"
          className="mt-3 buttons-container say-hello-button"
        >
          Say Hello
          <svg
            class="button_icon"
